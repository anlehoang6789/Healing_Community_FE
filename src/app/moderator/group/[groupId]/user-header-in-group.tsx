...
export default function UserHeaderInGroupForModerator({
  userId,
  createPost,
  groupId,
}: {
    ...
    <>
      ...
      <div>
        <div className="flex items-center space-x-2">
          ...
          {isExpert && (
            <div className="text-xs text-gray-100 font-semibold px-2 py-0.5 bg-gradient-to-r from-[#00c6ff] to-[#0072ff] rounded-full shadow-md">
              Chuyên gia
            </div>
          )}
        </div>
