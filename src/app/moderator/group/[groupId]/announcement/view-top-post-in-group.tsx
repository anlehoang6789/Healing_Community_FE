...
import UserHeaderTopPostInGroupForModerator from "@/app/moderator/group/[groupId]/announcement/user-header-top-post-in-group";

export default function ViewTopPostInGroupForModerator() {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-6 p-4">
                <UserHeaderTopPostInGroupForModerator
                  userId={post.userId}
