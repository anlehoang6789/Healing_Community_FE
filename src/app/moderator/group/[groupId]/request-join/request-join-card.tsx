...
import RequestJoinDetailsForModerator from "@/app/moderator/group/[groupId]/request-join/request-join-details";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { useGetRequestJoinGroupQuery } from "@/queries/useGroup";
import { useParams } from "next/navigation";

export default function RequestJoinCardForModerator() {
        ...
        {joinRequests.length === 0 ? (
          ...
          <ul className="space-y-4">
            {joinRequests.map((request) => (
              ...
              >
                <RequestJoinDetailsForModerator
