...
import AlertDialogDeletePersonalPostInGroupForModerator from "@/app/moderator/group-user/[groupId]/user/[userId]/delete-personal-post-in-group";
import EditPersonalPostInGroupForModerator from "@/app/moderator/group-user/[groupId]/user/[userId]/edit-personal-post-in-group";
...
export default function ViewPersonalPostInGroupForModerator({
  groupId,
  userId,
}: {
  groupId: string;
            ...
            return (
              ...
              >
                ...
                <AlertDialogDeletePersonalPostInGroupForModerator
                  ...
                  groupId={groupId}
                />
                <EditPersonalPostInGroupForModerator
                  postId={postId}
                  setPostId={setPostId}
                  onSubmitSuccess={() => {}}
                />
