"use client";
import { useGetReactionSharedCountQuery } from "@/queries/usePost";
import React from "react";

export default function ReactionSharedCount({ shareId }: { shareId: string }) {
  const { data, isLoading, isError } = useGetReactionSharedCountQuery(shareId);
